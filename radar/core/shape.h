...
namespace radar
{
    ...
    public:
        ...
        template <size_t I>
        size_t offset(const shape<I>&) const;
...
namespace radar
{
    ...
    template <size_t N>
    template <size_t I>
    size_t shape<N>::offset(const shape<I> &index) const
    {
    ...
    template <size_t N>
    template <size_t I>
    shape<N - I> shape<N>::flatten() const
    {
